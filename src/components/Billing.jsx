...
const Billing = () => (
    <section id='products' className={`${layout.sectionReverse}`}>
      <div className={layout.sectionImgReverse}>
        <img src={bill} alt="billing" className='floating-animation w-[100%] h-[100%] z-5' />
      ...
      <div className={layout.sectionInfo}>
        ...
        <div className='flex flex-row flex-wrap sm:mt-10 mt-6 '>
          <img src={apple} alt="app store" className='hover:scale-[1.1] duration-[0.5s] w-[128px] h-[42px] object-contain mr-5 cursor-pointer'/>
          <img src={google} alt="google play" className='hover:scale-[1.1] duration-[0.5s] w-[128px] h-[42px] object-contain cursor-pointer'/>
        </div>
      </div>
    </section>
  )
